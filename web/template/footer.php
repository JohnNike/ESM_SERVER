<div class="footer">
				<div class="footer-inner">
					<div class="footer-content">
						<span class="bigger-120">
							<span class="blue bolder"> <?= $content['config']['author'] ?> </span> &copy; <?= date("Y"); ?>
</span>
		...
		<!--[if !IE]> -->
		<script src="web/assets/js/jquery.2.1.1.min.js"></script>
...
<![endif]-->
	...
	window.jQuery || document.write("<script src='web/assets/js/jquery.min.js'>"+"<"+"/script>");
		</script>
		...
		<!--[if IE]>
<script type="text/javascript">
	window.jQuery || document.write("<script src='web/assets/js/jquery1x.min.js'>"+"<"+"/script>");
</script>
<![endif]-->
		<script type="text/javascript">
			if('ontouchstart' in document.documentElement) document.write("<script src='web/assets/js/jquery.mobile.custom.min.js'>"+"<"+"/script>");
		</script>
